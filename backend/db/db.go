...
func ConnectDB() error {
	...
	migrations := []string{
		...
		`ALTER TABLE reading_logs ADD COLUMN IF NOT EXISTS target_pages INTEGER DEFAULT 0`,
		`ALTER TABLE reading_logs ADD COLUMN IF NOT EXISTS reflection TEXT DEFAULT ''`,
